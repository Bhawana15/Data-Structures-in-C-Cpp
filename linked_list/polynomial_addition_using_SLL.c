// ERROR
// PROGRAM FOR ADDITION OF TWO POLYNOMIALS USING LINKED LIST
// The polynomials have been assumed for the sake of simplicity
// First Polynomial : p(x) = 3x^2 + 2x + 5
// Second Polynomial : q(x) = 5x^3 + 2x^2 + 3x
// Addition of the two polynomial : r(x) = 5x^3 + 5x^2 + 5x + 5
...
int main()
{
        ...
        printf("PROGRAM FOR ADDITION OF TWO POLYNOMIALS USING LINKED LIST\n");
        printf("################################################################\n");
...
void add_poly(POLY **poly1, POLY **poly2, POLY **poly)
{
	...
	{
		printf("1\n");
		// When power of terms of both the polynomial is same, then add their coefficients
		...
		// When power of first polynomial's terms is higher than that of second polynomial
		...
		// When power of second polynomial's terms is higher than that of first polynomial
		else
		{
	...
	// When atleast one has reached to the last term
	while((*poly1)->link != NULL || (*poly2)->link != NULL)
	{
		printf("3\n");
		if((*poly1)->link != NULL)
